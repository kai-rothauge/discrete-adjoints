classdef SwiftHohenberg < PDE
    
    properties (SetAccess = private)
        
        rosenbrock = 0;     % Rosenbrock-type approach
    ...
    methods (Access = public)
        function this = SwiftHohenberg(varargin)
            this.name      = 'SwiftHohenberg';
            this.linearity = 'semilinear';
            
            s = settings('SwiftHohenberg','grid');
            this.sd         = s.sd;
            s = settings('SwiftHohenberg','integration');
            this.rosenbrock = s.rosenbrock;
            this.set_basis();
            
%             if nargin == 1 && isnumeric(varargin{1})
%                 this.set_grid(settings('SwiftHohenberg','grid',varargin{1}));
%             else
                this.set_grid(settings('SwiftHohenberg','grid'));
%             end
        ...
        function set(this, varargin)
            for i = 1:2:nargin-1
                ...
                elseif strcmpi(parameter,'rosenbrock')
                    this.set_rosenbrock(varargin{i+1});
                end
            end
        end
        ...
        function set_sd(this,sd)
            if sd == 0 || strcmpi(sd,'pseudospectral')
                this.sd = 0;
            elseif sd == 6 || strcmpi(sd,'6') || strcmpi(sd,'6th order') || strcmpi(sd,'6th')
                this.sd = 6;
            else
                this.sd = 4;
            end
        ...
        function set_rosenbrock(this,rosenbrock)
            if rosenbrock == 1 || strcmpi(rosenbrock,'on')
                this.rosenbrock = 1;
            else
                this.rosenbrock = 0;
            end
...
%             end
        ...
        function out = is_rosenbrock(this)
            out = this.rosenbrock;
        end
